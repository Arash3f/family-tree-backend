...
_UPLOAD_MESSAGES: dict[str, dict[str, str]] = {
    ...
    "fa": {
        "not_xlsx": (
            "فقط فایل‌های اکسل با قالب xlsx قابل وارد کردن هستند. در اکسل از "
            "گزینهٔ «ذخیره با نام» قالب xlsx را انتخاب کنید."
        ),
        "empty_file": "فایل بارگذاری‌شده خالی است.",
        "preview_timeout": (
            "بررسی این فایل بیش از ۶۰ ثانیه طول کشید. لطفاً آن را به چند فایل "
            "کوچک‌تر تقسیم کنید."
        ),
        "import_timeout": (
            "وارد کردن اطلاعات بیش از ۵ دقیقه طول کشید و متوقف شد. لطفاً هر بار "
            "تعداد کمتری ردیف وارد کنید."
        ),
        "export_timeout": "خروجی گرفتن بیش از ۵ دقیقه طول کشید و متوقف شد.",
        "bad_selection": "فهرست ردیف‌های انتخاب‌شده خوانده نشد. دوباره تلاش کنید.",
    },
}

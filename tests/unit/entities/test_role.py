...
def test_duplicate_permissions_are_removed_on_init():
    role = create_role(permission_ids = [UUID(int=1), UUID(int=2), UUID(int=2), UUID(int=3), UUID(int=1)])

    assert role.permission_ids == [UUID(int=1), UUID(int=2), UUID(int=3)]


def test_remove_duplicate_permission_method():
    role = create_role(permission_ids = [UUID(int=1), UUID(int=1), UUID(int=2), UUID(int=3), UUID(int=3)])

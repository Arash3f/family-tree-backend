...
def mock_uow():
    ...
    tickets_repo.create = AsyncMock()
    tickets_repo.get = AsyncMock()
    tickets_repo.get_or_raise = AsyncMock()
    tickets_repo.get_list_by_filter = AsyncMock()
    tickets_repo.update = AsyncMock()

    ticket_messages_repo = MagicMock()

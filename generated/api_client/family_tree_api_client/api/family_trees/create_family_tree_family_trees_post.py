...
from ...models.family_tree_create_request import FamilyTreeCreateRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = FamilyTreeResponse.from_dict(response.json())

...
class MarriageUpdateDateRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        married_at: None | str | Unset
        if isinstance(self.married_at, Unset):
            married_at = UNSET
        elif isinstance(self.married_at, datetime.date):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_married_at(data: object) -> datetime.date | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        marriage_update_date_request = cls(
        ...
        marriage_update_date_request.additional_properties = d
        return marriage_update_date_request

...
class PersonCreateRequest:
    ...
    Example:
        {'birth_date': '2000-11-21', 'gender': 'male', 'name': 'arash', 'parents': [{'parent_id':
            '00000000-0000-0000-0000-000000000001', 'relationship_type': 'biological'}, {'parent_id':
            '00000000-0000-0000-0000-000000000002', 'relationship_type': 'biological'}]}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_create_request.additional_properties = d

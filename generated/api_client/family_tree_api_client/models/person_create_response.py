...
T = TypeVar("T", bound="PersonCreateResponse")
...
class PersonCreateResponse:
    """
    Example:
        {'birth_date': '2000-11-21', 'gender': 'male', 'name': 'arash', 'parents': [{'parent_id':
            '00000000-0000-0000-0000-000000000001', 'relationship_type': 'biological'}]}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_create_response.additional_properties = d
        return person_create_response

...
T = TypeVar("T", bound="MarriageCreateResponse")


@_attrs_define
class MarriageCreateResponse:
    """
    Attributes:
        id (UUID):
        spouse_a_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        marriage_create_response.additional_properties = d
        return marriage_create_response

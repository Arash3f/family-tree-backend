...
T = TypeVar("T", bound="MarriageUpdateResponse")


@_attrs_define
class MarriageUpdateResponse:
    """
    Attributes:
        id (UUID):
        spouse_a_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        marriage_update_response.additional_properties = d
        return marriage_update_response
